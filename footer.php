   ...
   <footer id="footer">
       <div class="container text-center text-white">
           <div class="d-flex justify-content-center">
               <div class="qrcode">
                   <!-- <img
              src="img/qr/The Palace Tower B - P51700033430.png"
              class="m-2" />
            <img
              src="img/qr/The Palace Tower C - P51700033431.png"
              class="m-2" /> -->
               </div>
           </div>
           <div>
               ...
               <p>
                   <a href="https://maharera.mahaonline.gov.in" style="color: #fff; text-decoration: none">
               ...
               <div>
                   ...
                   <br />
                   <span class="read_more2" onclick="toggleContent('dots20','more20', 'myBtn20')" id="myBtn20">
                       Read More
                   </span>
               </div>
               ...
               <p class="pb-4 pt-2">
                   ...
                   |
                   <a href="termsandcondition.html" target="_blank" style="text-decoration: none">
